...
| Skill 名称 | 用途 |
| --- | --- |
| mag-ai-project-release-timeline | 项目发布时间线skill,当用户需要记录项目发布信息（版本号、发布内容、负责人、发布周期等）并生成可视化的 HTML 时间线页面时触发此技能。适用于项目版本迭代记录、发布复盘、迭代汇报、多项目发布追踪等场景。触发关键词：发布时间线、版本记录、release timeline、发布记录、迭代记录、版本追踪、项目发布历程。 |
| mag-ai-personal-email-assistant | 网易邮箱个人邮件管理助手：通过网易邮箱连接器实现邮件的收发、搜索、汇总和管理。当用户提到查看邮件、未读邮件、收件箱、发邮件、回复邮件、搜索邮件、邮件汇总时触发此技能。适用于日常个人邮件处理的全场景。 |
| mag-ai-tech-trend-radar | 技术趋势研判skill：对目标 AI 技术进行结构化研判，通过联网搜索采集多源信号，从成熟度、商业价值、团队适配度、风险成本四个维度评估，给出技术雷达定位（Adopt/Trial/Assess/Hold）与可执行的行动建议，最终输出结构化研判报告。适用于技术选型决策、季度技术规划、团队技术方向对齐等场景。 |
